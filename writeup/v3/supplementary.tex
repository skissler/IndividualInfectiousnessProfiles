...
\label{sec:supplementary_methods_timeshift}
...
\clearpage
\subsubsection{Inference of the effective sample size for estimating $g(\tau)$}
\label{sec:supplementary_methods_neff}

\clearpage


\subsubsection{Calculating overdispersion}
\label{sec:supplementary_methods_overdispersion}
...
\subsubsection{Invariance of infection-anchored TE to the shape of the infectiousness profile}
\label{sec:supplementary_methods_TE-invariance}

\subsubsection{Derivation of the truncated generation interval distribution under D\&I interventions}
\label{sec:supplementary_methods_truncated-gi-derivation}

\subsubsection{Derivation of $R_{eff}$ and OD for gathering size restrictions}
\label{sec:supplementary_methods_gathering-size}
